...
SELECT DISTINCT album_id, Users.user_id, album_name, album_created_time, album_modified_time, album_link, album_visibility, cover_photo_id
FROM project1.Public_Photo_Information pp
JOIN Users on pp.owner_id = Users.user_id
join Photos on pp.cover_photo_id = Photos.photo_id;
